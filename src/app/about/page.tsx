...
export default function AboutPage() {
  ...
  return (
    <main>
      ...
      <section className="content-section content-section-compact section-dark"><div className="shell"><h2 className="content-heading" style={{ marginBottom: 56 }}>Why one person beats an agency.</h2><div className="about-points">{points.map((point, index) => <div className="about-point" key={point}><span>0{index + 1}</span>{point}</div>)}</div></div></section>

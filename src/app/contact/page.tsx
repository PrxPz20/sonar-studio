...
import type { ContactTier } from "@/lib/contact-schema";
...
export default async function ContactPage({ searchParams }: { searchParams: Promise<{ tier?: string | string[] }> }) {

  ...
  return (
    <div className="contact-form-shell">
      ...
      {status === "success" ? (
        ...
        <label><span>Country <b>Optional</b></span><select name="country" defaultValue="" {...field("country")}><option value="">Select country</option><option>United Kingdom</option><option>Ireland</option><option>Cyprus</option><option>Other</option></select>{error("country")}</label>
        <label><span>City <b>Optional</b></span><input name="city" autoComplete="address-level2" {...field("city")} />{error("city")}</label>
